        ...
        <header className="navbarContainer NavbarInteractive">
          ...
          <div className="desktopMenu">
            <nav className="navbarLinks">
              ...
              <span className="bodySmall">Skills</span>
              <span className="bodySmall">Projects</span>
              <span className="bodySmall">Community</span>
          ...
          <div className={`mobileMenu ${showMenu ? "show" : ""}`}>
            ...
            <div className="SocialIcons">
              <svg viewBox="0 0 950.8571428571428 1024" className="socialIcons">
              ...
              <svg viewBox="0 0 877.7142857142857 1024" className="socialIcons">
              ...
              <svg viewBox="0 0 602.2582857142856 1024" className="socialIcons">
